...
#'@param eff.size Numeric. Effect size
#'@param n1 Numeric. Cluster size
#'@param n2 Numeric. Total number of clusters.
#'@param n.datasets Numeric. Number of data sets that the user wants to generate to determine the sample size.
#'@param rho Numeric. Intraclass correlation
#'@param BF.thresh Numeric. Value of the Bayes factor that is going to be the threshold.
